...
import com.soffice.utils.IconUtils;
...
import static com.soffice.consts.FrameConst.JIRA_DOMAIN;
...
public final class ExtentReportManager {
    ...
    private static void updateContent() {
        ...
        /* Project mới chưa có logo riêng -> giữ logo mặc định Spark.
         * Khi có logo riêng, đặt file vào report output folder và set newLogo path tương ứng. */
        String newLogo = defaultLogo;
