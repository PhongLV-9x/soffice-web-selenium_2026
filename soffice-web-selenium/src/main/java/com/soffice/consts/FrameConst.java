...
public class FrameConst {
    ...
    public static String PROJECT_NAME = "Soffice";           // Project Name
    public static String PROJECT_KEY_NAME = "Soffice";              // Support Generate Test Case automatically then upload to Jira
    public static String PROJECT_RESULT_DB = "soffice";         // Database Name for storing test results
    public static String JIRA_DOMAIN = "";
    public static String LOG_LEVEL = "DEBUG";
    public static String LANG = LANG_VI;

    public static List<Object> DATABASE_CONNECT_LIST = new ArrayList<>();
    ...
    public static class AppConfig {
        ...
        public static String APP_DOMAIN = "https://soffice-sg.aits.vn/";
        public static String API_DOMAIN = "https://soffice-sg.aits.vn/";
