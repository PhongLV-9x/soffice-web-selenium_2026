...
import com.soffice.report.ReportConfig;
import com.soffice.utils.configloader.AbsPropertyUtils;
import com.soffice.utils.configloader.ResourceReader;
...
import static com.soffice.consts.FrameConst.*;
...
public class PropertiesUtils extends AbsPropertyUtils {
    ...
    public void updateMavenProperties(Properties property, JSONObject configObjects) {
        ...
        // Common report
        PROJECT_NAME = property.getProperty("projectName", "SOFFICE");
        ...
        ReportConfig.AUTHOR = property.getProperty("author", "Soffice");
        ReportConfig.REPORT_TITLE = property.getProperty("reportTitle", "Soffice Automation Report");
    ...
    public void executionInfo(Properties properties) {
        System.out.println("\n\n==================EXECUTION INFO========================");
        System.out.println("\tWEB AUTOMATION - SOFFICE SYSTEM");
